...
/*
 * CEILING is 12msec, larger than any standard
	...
	char *buf)
{
	...
	time_diff = suspend_time_ms_plus();
	/*
...
void compute_work_load_plus(struct devfreq_dev_status *stats,
				...
				u32 *flag)
{
	...
	*freq = stats.current_frequency;
	...
	compute_work_load_plus(&stats, priv, devfreq);
	/*
...
static int tz_handler(struct devfreq *devfreq, unsigned int event, void *data)
{
	...
	case DEVFREQ_GOV_RESUME:
		spin_lock(&suspend_lock);
		suspend_time += suspend_time_ms_plus();

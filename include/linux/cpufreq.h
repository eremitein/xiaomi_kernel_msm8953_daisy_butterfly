...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_NONCONSERVATIVE)
extern struct cpufreq_governor cpufreq_gov_nonconservative;
#define CPUFREQ_DEFAULT_GOVERNOR (&cpufreq_gov_nonconservative)
